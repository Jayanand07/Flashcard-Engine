  ...
  return (
    <div className="mx-auto w-full cursor-pointer select-none" style={{ perspective: "1200px", maxWidth: "640px" }} onClick={onFlip}>
      <div className="relative w-full" style={{
        ...
        {/* Front */}
        <div className="absolute inset-0 flex flex-col items-center justify-center overflow-hidden rounded-2xl px-10 py-12 sm:px-14"
          style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", background: "var(--surface)", border: "1px solid var(--border)", boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
        ...
        {/* Back */}
        <div className="absolute inset-0 flex flex-col items-center justify-center overflow-hidden rounded-2xl px-10 py-12 sm:px-14"
          style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden", transform: "rotateY(180deg)", background: "var(--surface)", border: "1px solid var(--border)", boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
